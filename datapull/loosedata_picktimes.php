...
foreach ($whsearray as $whsesel) {
    ...
    $printhourmin = intval(date('Hi', strtotime('-2000 minutes')));  //this is local to the DC because of timezone set.
    $printhourmin_colon = (date('H:i', strtotime('-2000 minutes')));  //this is local to the DC because of timezone set.
