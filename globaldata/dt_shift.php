...
foreach ($shiftsql_array as $key => $value) {
    ...
    $rowpush = array($SHIFT_TSMNUM, $SHIFT_FIRSTNAME, $SHIFT_LASTNAME, $SHIFT_WHSE, $SHIFT_BUILD, $SHIFT_POSITION, $SHIFT_STANDHOURS, $SHIFT_STARTTIME, $SHIFT_ENDTIME, $SHIFT_BREAK1, $SHIFT_BREAK2, $SHIFT_LUNCH, $SHIFT_OTHOURS, $SHIFT_INCLUDEHOURS, $SHIFT_CORL,' ');
