...
WHERE
    BILLTONUM = $var_sqldata and RETURNCODE in ('IBNS','WISP','WQSP')"
...
<div class="portlet light bordered">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-green-sharp bold uppercase">Data for Bill To #: <span style="background-color: black; color: #dddada"><?php echo $var_sqldata; ?></span></span>
        </div>
    </div>
