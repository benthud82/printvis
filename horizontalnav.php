...
<header id="header" class="navbar"   style="border-radius: 0px;position: fixed; width: 100%; top: 0; z-index: 1030;">
    ...
    <?php if (isset($_SESSION['MYUSER'])) { ?>
        <?php
        if (strtoupper($_SESSION['MYUSER']) === 'BHUD01' || strtoupper($_SESSION['MYUSER']) === 'JMOO07' || strtoupper($_SESSION['MYUSER']) === 'DMCKEE' || strtoupper($_SESSION['MYUSER']) === 'AROB01'|| strtoupper($_SESSION['MYUSER']) === 'EIGRIS'){
